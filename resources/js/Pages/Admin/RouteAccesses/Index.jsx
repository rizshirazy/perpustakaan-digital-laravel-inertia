...
import { IconArrowsUpDown, IconPencil, IconPlus, IconRefresh, IconRoute, IconTrash } from '@tabler/icons-react';
...
export default function Index(props) {
    ...
    const onHandleDelete = (id) => {
        router.delete(route('admin.route-accesses.destroy', id), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: (success) => {
                                        ...
                                        <div className="flex items-center gap-x-1">
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        <AlertDialogTitle>
                                                            Apakah anda yakin menghapus akses rute{' '}
                                                            {route_access.route_name}?
                                                        </AlertDialogTitle>
                                                        <AlertDialogDescription>
                                                            Tindakan ini tidak dapat dibatalkan dan akan menghapus akses
                                                            rute beserta seluruh data yang berhubungan dengan akses rute
                                                            ini.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Batal</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => onHandleDelete(route_access)}>
                                                            Hapus
                                                        </AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
