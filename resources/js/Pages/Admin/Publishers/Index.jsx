...
export default function Index(props) {
    ...
    const onHandleDelete = (id) => {
        router.delete(route('admin.publishers.destroy', id), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: (success) => {
                                        ...
                                        <div className="flex items-center gap-x-1">
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        <AlertDialogTitle>
                                                            Apakah anda yakin menghapus penerbit {publisher.name}?
                                                        </AlertDialogTitle>
                                                        <AlertDialogDescription>
                                                            Tindakan ini tidak dapat dibatalkan dan akan menghapus
                                                            penerbit beserta seluruh data yang berhubungan dengan
                                                            penerbit ini.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Batal</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => onHandleDelete(publisher)}>
                                                            Hapus
                                                        </AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
