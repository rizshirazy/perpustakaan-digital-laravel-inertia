...
import { IconArrowsUpDown, IconPencil, IconPlus, IconRefresh, IconTrash, IconVersions } from '@tabler/icons-react';
...
export default function Index(props) {
    ...
    const onHandleDelete = (permissionId) => {
                                        ...
                                        <div className="flex items-center gap-x-1">
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        <AlertDialogTitle>
                                                            Apakah anda yakin menghapus izin {permission.name}?
                                                        </AlertDialogTitle>
                                                        <AlertDialogDescription>
                                                            Tindakan ini tidak dapat dibatalkan dan akan menghapus izin
                                                            beserta seluruh data yang berhubungan dengan izin ini.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Batal</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => onHandleDelete(permission)}>
                                                            Hapus
                                                        </AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
