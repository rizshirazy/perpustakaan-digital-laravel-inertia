...
import { IconArrowsUpDown, IconPencil, IconPlus, IconRefresh, IconTrash, IconUsersGroup } from '@tabler/icons-react';
                        ...
                        <TableBody>
                            {users.map((user, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{user.gender.label}</TableCell>
                                    <TableCell>{user.created_at.formatted}</TableCell>
                                    <TableCell>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogDescription>
                                                            ...
                                                            pengguna beserta seluruh data yang berhubungan dengan
                                                            pengguna ini.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Batal</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => onHandleDelete(user)}>
                                                            Hapus
                                                        </AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
