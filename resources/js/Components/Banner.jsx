...
export default function Banner({ message = '', url }) {
    ...
    return (
        <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:flex sm:justify-center sm:px-6 lg:px-8 lg:pb-5">
            <div className="pointer-events-auto flex items-center justify-between gap-x-6 bg-gradient-to-r from-orange-400 to-orange-500 px-6 py-2.5 sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
